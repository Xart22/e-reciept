                ...
                <div class="card-body">
                    <div class="container">
                        <form class="row g-3" action="{{ route('toko.store') }}" method="post"
                            enctype="multipart/form-data" id="formToko">
                            @csrf
                            <div class="col-md-6">
                                <label for="nama_toko" class="form-label">Nama Toko</label>
                                <input type="text" class="form-control" id="nama_toko" required name="nama_toko"
                                    value="{{ old('nama_toko') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="alamat_toko" required name="alamat_toko"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="telepon_toko" required name="telepon_toko"
                                    value="{{old('telepon_toko')}}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" id="email_toko" required name="email_toko"
                            ...
                            <div class="col-12">
                                ...
                                <input type="file" class="form-control" id="logo_toko" required name="logo_toko"
                                    value="{{old('logo_toko')}}">
                            </div>
                            <div class="col-12">
